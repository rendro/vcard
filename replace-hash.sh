...
sed "s/{commit.hash}/$hash/g" tmp/index.html > _site/index.html
sed "s/{commit.hash}/$hash/g" tmp/error/403.html > _site/error/403.html
sed "s/{commit.hash}/$hash/g" tmp/error/404.html > _site/error/404.html
sed "s/{commit.hash}/$hash/g" tmp/error/500.html > _site/error/500.html
